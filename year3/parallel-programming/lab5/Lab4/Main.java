...
public class Main {
    ...
    private static final int p1 = 2;   // numarul de threaduri citire
    private static final int p2 = 4;   // numarul de threaduri worker
...
//        generateFiles();
        ...
        Paralel paralel = new Paralel(n, p1, p2, baseDataPath);
        startTime = System.nanoTime();
        paralel.resolve();
        endTime = System.nanoTime();
