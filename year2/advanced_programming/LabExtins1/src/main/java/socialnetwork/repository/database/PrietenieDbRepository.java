...
public class PrietenieDbRepository implements Repository<Tuple<Long, Long>, Prietenie> {
    ...
    public Optional<Prietenie> findOne(Tuple<Long, Long> aLong) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
             PreparedStatement statement = connection.prepareStatement("SELECT id1, id2 from prietenii");
            ...
            while (resultSet.next()) {
                ...
                if (id.equals(aLong))
                    o = Optional.of(new Prietenie(id));
            }
    ...
    public Optional<Prietenie> save(Prietenie entity) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
             PreparedStatement statement = connection.prepareStatement("INSERT INTO prietenii(id1, id2) VALUES (?,?)");
        ) {
