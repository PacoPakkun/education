...
import ams.NotificationReceiver;
...
public class MainController extends UnicastRemoteObject implements Serializable, NotificationSubscriber {
    ...
    public void notificationReceived(Notification notif) {
        try {
            System.out.println("Ctrl notificationReceived ... ");
